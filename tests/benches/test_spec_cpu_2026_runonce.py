...
from benchkit.benches.speccpu2026 import SPECCPU2026Bench
...
def main() -> None:
    if len(sys.argv) < 2:
        print("Usage: python test_spec_cpu_2026_runonce.py <PATH_TO_SPEC_ISO>", file=sys.stderr)
        exit(1)
