...
class ThreadCounterBench(Benchmark):
    ...
    def parse_output_to_results(  # pylint: disable=arguments-differ
        ...
        **_kwargs,
        ...
        result_dict = self._parse_results(log_output=command_output, itterations=itterations, size=size, cores=cores)
        return result_dict
    ...
    def single_run(  # pylint: disable=arguments-differ
        ...
        **_kwargs,
        ...
        command = ["./ParallelIntPoolCircularOfsetAlignedSingleVec", "-seed", str(90), "-i", str(itterations), "-s", str(size), "-t", str(cores),
...
def ParallelIntPoolCircularOfsetAlignedSingleVec_campaign(
    name: str = "campaign",
