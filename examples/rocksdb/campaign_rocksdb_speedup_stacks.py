...
def main() -> None:
    ...
    #     duration_transformation=lambda d: time_transformation(d, "s", "ns"),
    #     speedup_stack_components={
    #         "klockstat_total_wait_ns": lambda d, nb_t: d,
    #         "offcputime_total_micro_s": lambda d, nb_t: time_transformation(d, "us", "ns"),
    #         "llcstat_total_nr_misses": lambda d, nb_t: d,
    #         "strace_total_time_s": lambda d, nb_t: time_transformation(d, "s", "ns"),
    #     },
    #     constant_duration=True,
    #     speed_metric="operations/second",
    # )
