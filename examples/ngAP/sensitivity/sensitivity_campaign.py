...
from configs.parse_options import gen_dict_list, possible_vars

class SensitivityBench(Benchmark):
...
def main():
    ...
    configs = [
        ("app_spec_ngap_new_quickvalidation_part1","exec_config_ngap_groups_design_sota_oneinput"),
        ("app_spec_ngap_new_quickvalidation_part1","exec_config_ngap_groups_best_oneinput"),
        ("app_spec_ngap_new_quickvalidation_part1","exec_config_ngap_groups_design_sota_runahead_oneinput"),
        ("app_spec_ngap_new_quickvalidation_part1","exec_config_ngap_groups_nap_default_oneinput"),

        ("app_spec_ngap_new_quickvalidation_part2","exec_config_ngap_groups_best_oneinput"),
        ("app_spec_ngap_new_quickvalidation_part2","exec_config_ngap_groups_design_sota_runahead_oneinput"),
        ("app_spec_ngap_new_quickvalidation_part2","exec_config_ngap_groups_nap_default_oneinput"),

        ("app_spec_ngap_new_quickvalidation_part4","exec_config_ngap_groups_best_4degree_oneinput"),
        ("app_spec_ngap_new_quickvalidation_part4","exec_config_ngap_groups_design_sota_4degree_oneinput"),
        ("app_spec_ngap_new_quickvalidation_part4","exec_config_ngap_groups_nap_default_4degree_oneinput"),
        ("app_spec_ngap_new_quickvalidation_part4","exec_config_ngap_groups_design_sota_runahead_4degree_oneinput"),
    ]
    ...
    for app, config in configs:
        ...
        campaigns.append(ngap_breakdown_campaign(
            app_file=app_path,
            config_file=config_path,
            name=f"sensitivity-{app}-{config}"
        ))
