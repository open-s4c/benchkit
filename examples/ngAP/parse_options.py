...
# generates the list of dicts for the campaign from the config and app files
...
# All the command attributes that were not initialized through the config and
# app file are init to None
