...
class WrMemBench(Benchmark):
	"""Benchmark object for Metis wrmem benchmark."""
	...
	def single_run(
		...
		**kwargs,
		...
		# default in bench: uint64_t inputsize = 0x80000000;
		if input_size > 0:
			run_command.append(f"{_COMMAND_LINE_ARGS['input_size']} {input_size}")
