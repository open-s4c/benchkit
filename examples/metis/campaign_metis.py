...
WRMEM_NB_TASKS_REDUCE = 0  # reduce tasks : nb of reduce tasks
# (determined by sampling by default, disables sampling if not zero)
...
WR_DATA_PATH_3 = (
    "wr/800MB.txt"  # many keys and many duplicates. The input is generated via data/data-gen.sh
)
# The input is generated by data/data-gen.sh
WR_DATA_PATH_4 = "wr/500MB.txt"  # many keys and many duplicates, but unpredictable.
WR_NB_PROCS = 0
WR_NB_TASKS_MAP = 0
